...
ctypes.windll.kernel32.SetConsoleTitleW("GomesBot | Loading...")
...
def updateTitle():
    ...
    ctypes.windll.kernel32.SetConsoleTitleW("GomesBot | Snipe Completed | " + str(walletBalance) + " BNB")
...
#addressToSnipe = input("Contrato aguardando liquidez: ")

addressToSnipe="0xA78fD59D898B54E5D7bAc783B43ef45Bb87Ec9cd"
getTokenName = web3.eth.contract(address=addressToSnipe, abi=tokenNameABI) #code to get name and symbol from token address

tokenName = getTokenName.functions.name().call()
tokenSymbol = getTokenName.functions.symbol().call()
print(style.YELLOW + currentTimeStamp + " [Token] New potential token detected: " + style.CYAN + tokenName + " (" + tokenSymbol + "): " + style.MAGENTA + addressToSnipe + style.RESET)


contract = web3.eth.contract(address=addressToSnipe, abi=listeningABI)

print("Contrato")
print(repr(contract.events.PairCreated))

#tokenPairAddress = contract.events
